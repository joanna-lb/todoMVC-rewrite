...
exports.deleteTodoAction = exports.fetchTodoList = exports.createTodo = exports.updateTodoAction = exports.BASE_URL = void 0;
const tslib_1 = require("tslib");
const axios_1 = tslib_1.__importDefault(require("axios"));
exports.BASE_URL = 'http://localhost:3000/todos';
// const updateTodoAction = (id, data) => axios.patch(`${BASE_URL}/${id}`, data)
const fetchTodoList = () => fetch(exports.BASE_URL, {
    method: 'GET',
});
