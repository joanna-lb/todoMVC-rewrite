...
const setTodoList = (todos) => {
    return ({ type: constants_1.SET_TODO_LIST, payload: { data: todos } });
};
exports.setTodoList = setTodoList;
const addTodo = (todo) => {
    return ({ type: constants_1.ADD_TODO, payload: { todo: todo } });
};
exports.addTodo = addTodo;
const setAllTasksCompleteStatus = (status) => {
    return ({ type: constants_1.SET_ALL_TASKS_COMPLETE_STATUS, payload: { todo: { isComplete: status } } });
};
exports.setAllTasksCompleteStatus = setAllTasksCompleteStatus;
const changeCompleteStatus = (id, status) => {
    return ({ type: constants_1.CHANGE_COMPLETE_STATUS, payload: { todo: { id, isComplete: status } } });
};
exports.changeCompleteStatus = changeCompleteStatus;
const deleteTodo = (id) => {
    return ({ type: constants_1.DELETE_TODO, payload: { todo: { id } } });
};
exports.deleteTodo = deleteTodo;
const editTodoList = (id, name) => {
    return ({ type: constants_1.EDIT_TODO_LIST, payload: { todo: { id, name } } });
};
